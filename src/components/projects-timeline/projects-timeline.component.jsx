...
const TimeLine = () => {
  return (
    <div id="projects">
      <h1 className="pt-3 text-center font-details-b pb-3">PROJECTS<br/><h4>(Rimi these are not real gha prototypes I have fire Projects incomming Incha'Allah)</h4></h1>
      <Timeline>
        <Events>
        {/* Project: Todo List With MUI */}
        <ImageEvent
            date="RIMI WEIRDCHAMP"
